...
function CustomCaption(props: { calendarMonth: { date: Date } }) {
    ...
    return (
        <div className="flex items-center justify-center gap-4 pb-4 pt-2 relative">
            <button
                className="h-7 w-7 p-0 hover:bg-transparent text-[var(--color-aegean-blue)] hover:text-[var(--color-deep-med)] flex items-center justify-center disabled:opacity-30 transition-colors"
